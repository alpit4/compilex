    ...
    <div className="min-h-screen  transition-colors mt-24">
      ...
      <section className="min-h-screen flex flex-col justify-center items-center px-4 pt-16">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <Badge
            variant="secondary"
            className="mb-8 bg-indigo-50 dark:bg-indigo-950 text-indigo-700 dark:text-indigo-300 border-indigo-200 dark:border-indigo-800 hover:bg-indigo-100 dark:hover:bg-indigo-900"
          >
          ...
          <h1 className="text-2xl md:text-5xl lg:text-6xl font-black text-gray-900 dark:text-white leading-tight mb-8">
            ...
            <span className="relative inline-block">
              <span className="px-6 py-3 bg-indigo-500 dark:bg-indigo-400 text-white dark:text-gray-900 rounded-2xl transform -rotate-1 inline-block shadow-lg">
                Problem
              </span>
            </span>{" "}
            Solving
            ...
            with{" "}
            <span className="relative inline-block">
              <span className="px-6 py-3 bg-indigo-600 dark:bg-blue-500 text-white rounded-2xl transform rotate-1 inline-block shadow-lg">
                Code
              </span>
            </span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
            <Button
              size="lg"
              className="bg-indigo-500 hover:bg-indigo-600 dark:bg-indigo-400 dark:hover:bg-indigo-500 text-white dark:text-gray-900 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all"
            >
      ...
      {/* CTA Section */}
      <section className="py-24 bg-gradient-to-r from-indigo-600 to-indigo-300  dark:from-indigo-600 dark:to-indigo-600 rounded-md">
